...
(function () {
  ...
  const PRELOAD = {
    BTC: {
      price: 77102,
      rpSTH: 71150, sthSopr: 1.002, nuplSTH: 0.12,
      cdd: 3, netflow: -2800,
    ...
    ETH: {
      price: 2519,
      rpSTH: 2155, sthSopr: 1.002, nuplSTH: 0.08,
      lthNet30: 0.39,
  ...
  const BACKTEST = [
    ...
    { date: "Hoy",      evt: "Lectura actual",      price: 77102, comp: -0.25, sig: "NEUTRAL",       mov: 0,   out: "TBD", today: true },
  ];
