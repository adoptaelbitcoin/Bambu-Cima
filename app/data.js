...
(function () {
  ...
  const PRELOAD = {
    BTC: {
      price: 84383,
      rpSTH: 72719, sthSopr: 1.002, nuplSTH: 0.12,
      cdd: 3, netflow: -2800,
    ...
    ETH: {
      price: 2687,
      rpSTH: 2240, sthSopr: 1.002, nuplSTH: 0.08,
      lthNet30: 0.39,
  ...
  const BACKTEST = [
    ...
    { date: "Hoy",      evt: "Lectura actual",      price: 84383, comp: -0.25, sig: "NEUTRAL",       mov: 0,   out: "TBD", today: true },
  ];
