...
(function () {
  ...
  const PRELOAD = {
    BTC: {
      price: 81178,
      rpSTH: 71594, sthSopr: 1.002, nuplSTH: 0.12,
      cdd: 3, netflow: -2800,
    ...
    ETH: {
      price: 2643,
      rpSTH: 2191, sthSopr: 1.002, nuplSTH: 0.08,
      lthNet30: 0.39,
  ...
  const BACKTEST = [
    ...
    { date: "Hoy",      evt: "Lectura actual",      price: 81178, comp: -0.25, sig: "NEUTRAL",       mov: 0,   out: "TBD", today: true },
  ];
