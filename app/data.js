...
(function () {
  ...
  const PRELOAD = {
    BTC: {
      price: 83464,
      rpSTH: 72706, sthSopr: 1.002, nuplSTH: 0.12,
      cdd: 3, netflow: -2800,
    ...
    ETH: {
      price: 2663,
      rpSTH: 2229, sthSopr: 1.002, nuplSTH: 0.08,
      lthNet30: 0.39,
  ...
  const BACKTEST = [
    ...
    { date: "Hoy",      evt: "Lectura actual",      price: 83464, comp: -0.25, sig: "NEUTRAL",       mov: 0,   out: "TBD", today: true },
  ];
