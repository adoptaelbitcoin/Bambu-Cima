...
(function () {
  ...
  const PRELOAD = {
    BTC: {
      price: 76139,
      rpSTH: 71307, sthSopr: 1.002, nuplSTH: 0.12,
      cdd: 3, netflow: -2800,
    ...
    ETH: {
      price: 2417,
      rpSTH: 2170, sthSopr: 1.002, nuplSTH: 0.08,
      lthNet30: 0.39,
  ...
  const BACKTEST = [
    ...
    { date: "Hoy",      evt: "Lectura actual",      price: 76139, comp: -0.25, sig: "NEUTRAL",       mov: 0,   out: "TBD", today: true },
  ];
